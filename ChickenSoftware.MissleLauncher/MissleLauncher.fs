namespace ChickenSoftware.MissleLauncher
...
type public MissileLauncher() = 
    ...
    member this.DOWN = Array.append [|byte(2);byte(1)|] (Array.zeroCreate 8)
    member this.LEFT = Array.append [|byte(2);byte(4)|] (Array.zeroCreate 8)
    member this.RIGHT = Array.append [|byte(2);byte(8)|] (Array.zeroCreate 8)
    member this.FIRE = Array.append [|byte(2);byte(0x10)|] (Array.zeroCreate 8)
    member this.STOP = Array.append [|byte(2);byte(0x20)|] (Array.zeroCreate 8)
    member this.LED_ON = Array.append [|byte(3);byte(1)|] (Array.zeroCreate 9)
    member this.LED_OFF = Array.append [|byte(3)|] (Array.zeroCreate 9)
